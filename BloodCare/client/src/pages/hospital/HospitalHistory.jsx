...
const HospitalHistory = () => {
  ...
  return (
    <Layout>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-800">Blood Request History</h1>
        <p className="text-gray-500 text-sm mt-1">All blood requests made by your hospital</p>
      </div>
      <DataTable title="Request History" columns={columns} data={history} loading={loading} />
    </Layout>
  );
};
